...
```
cd existing_repo
git remote add origin https://gitlab.mypartner-isc.com/eco-trans/backend/eco-trans-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.mypartner-isc.com/eco-trans/backend/eco-trans-backend/-/settings/integrations)
...
docker compose -f docker-compose-local.yml up --build -V
...
npx typeorm migration:generate src/db/migrations/name_of_migration -d dist/db/data-source.js
